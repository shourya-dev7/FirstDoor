...
export default function Intake() {
  ...
  // Which branch of the flow to run.
  ...
  // "None of these apply" and warning signs are mutually exclusive.
  ...
  async function handleSubmit(event) {
    ...
    try {
       ...
       * ---------------------------------------------------------
       *
       * Physical symptoms go to the FastAPI backend.
       ...
       * ---------------------------------------------------------
       *
       * This flow uses the existing screening instrument logic.
       * It does NOT send the emotional questionnaire to the
       * physical triage endpoint.
       */

      if (isEmotional) {
        const screeningResult = scoreScreening({
          instrument,
          ageBand,
          responses,
        });
    ...
    <>
      <style>{`
        ...
        * {
        ...
        .in-bar {
          ...
          align-items: center;
          padding: 20px 6vw;
          border-bottom: 1px solid #12414C;
        }
        ...
        .in-opt input:focus-visible {
          outline: 2px solid #02C39A;
          outline-offset: 2px;
        }

        .in-opt:has(input:checked) {
          border-color: #02C39A;
          background: #ECF7F3;
        }
        ...
        .in-flags {
          background: #FBEAE4;
          border: 1px solid #E0AF9E;
          border-left: 3px solid #B4442C;
          border-radius: 11px;
          padding: 22px 24px;
          margin-top: 34px;
        }
        ...
        .in-flag input:focus-visible {
          outline: 2px solid #B4442C;
          outline-offset: 2px;
        }

        .in-flag:has(input:checked) {
          border-color: #B4442C;
          background: #F9E4DD;
        }

        .in-flag:focus-within {
          border-color: #B4442C;
        }
      ...
      <div className="in">
        <header className="in-bar">
          <Link className="in-mark" to="/">
            First<span>Door</span>
          </Link>
        ...
        <div className="in-wrap">
          <div className="in-intro">
            <h1 className="in-h1">
              A few questions, then <em>which door</em>.
            </h1>

            <p className="in-sub">
              Answer in your own words. FirstDoor works out how urgent this is
              and who should look at it — it does not name a condition and it
              does not suggest a medicine.
            </p>
          </div>
          ...
          >
            ...
            {isPhysical && (
              <>
                <fieldset className="in-q">
                  ...
                  <p className="in-help">
                    Where it is, what it feels like, and anything that makes it
                    better or worse.
                  </p>
                ...
                <fieldset className="in-q in-flags">
                  ...
                  <p className="in-help">
                    Tick everything that applies. Any one of these sends you
            ...
            {isEmotional && (
              <>
                ...
                <fieldset className="in-q">
                  ...
                  <p className="in-help">
                    In your own words. Nothing here is used to pick your
                    questions.
                  </p>
                ...
                {isMinor && (
                  <fieldset className="in-q">
                    ...
                    <div className="in-notice">
                      <p className="in-notice-label">
                        Not screened here
                      </p>

                      <p>
                        A mental health screening should have an adult
                        involved, so FirstDoor does not put these questions to
                        anyone under 18. Continue to see who you can talk to.
                      </p>
                    </div>
                  </fieldset>
                )}
            ...
            <p className="in-warn">
              FirstDoor does not diagnose conditions and does not recommend
              medication. If you think this is an emergency, call your local
              emergency number now.
            </p>
          </form>

          <p className="in-foot">
            Triage and referral support. Not a diagnosis, and not a substitute
            for a clinician.
          </p>
        </div>
      </div>
